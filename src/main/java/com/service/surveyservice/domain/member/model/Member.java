...
public class Member extends MemberBase {
    ...
    @Builder
    public Member(Long id, String password, String email, String username, String organization, String organizationDetail, String nickname, String mImageURL, MemberLoginType memberLoginType, Authority authority) {
        super(id, password, email, username, organization, organizationDetail, authority, memberLoginType);
