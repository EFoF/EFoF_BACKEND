...
import static com.service.surveyservice.domain.token.exception.response.TokenErrorResponse.*;
...
public class TokenExceptionHandler {
    ...
    @ExceptionHandler(NoSuchCookieException.class)
    public final ResponseEntity<ErrorResponse> handleNoSuchCookieException(NoSuchCookieException ex, WebRequest request) {
        log.info(request.getDescription(false));
